package com.example.detailsearch;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void search(String keyword) {
        ...
        // Construct the SQL query to search for records matching the keyword in meter number or name
        String query = "SELECT * FROM customer WHERE meter_no LIKE '%" + keyword + "%' OR name LIKE '%" + keyword + "%'";
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                String displayText = "Meter No: " + meterNo + "\nName: " + name;
    ...
    private void generatePDF() {
        ...
        Cursor c = db.rawQuery("SELECT * FROM customer WHERE meter_no='" + meter + "'", null);
        if (c.moveToFirst()) {
            String c_meter=c.getString(0);
